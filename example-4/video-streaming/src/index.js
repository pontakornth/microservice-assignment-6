...
function setupHandlers(app, messageChannel) {
  app.get("/video", (req, res) => {
    ...
    const videoPaths = {
      ...
      2: "./videos/cat-video.mp4",
    };
    // Note: There is no error handling if ID does not exist.
    // Currently, it is outside scope of this assignment so I will not do it.
    // I probably do it in the real project.
    const videoPath = videoPaths[req.query.id];
